...
`adapter` is a deployment-neutral OpenAI-compatible proxy for private or self-hosted model servers. It handles file adaptation, optional web augmentation, SSRF protection, and SSE streaming preservation.
...
- Preserve the separation between `/v1` and `/web/v1`.
